...
from cut_resize_tools import (
    ...
    select_conv, proccess_npyAppend, maximum_value_determination, 
    normalization, normalization_sigma, normalization_thresh
)
...
OUTPUT_DIR = "/home/filament/fujimoto/Cygnus-X_CAE/data/zroing_resize_data/resize_data/3size_per_norm/"
OUTPUT_FILE_NAME = "CygnusX_cut_3size_resize_to_100x100_per_norm"
